...
[![CI/CD Pipeline](https://github.com/ZinTrust/ZinTrust/actions/workflows/ci.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/ci.yml?query=branch%3Adev)
[![SonarQube Analysis](https://github.com/ZinTrust/ZinTrust/actions/workflows/sonarqube.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/sonarqube.yml?query=branch%3Adev)
[![Security Scan](https://github.com/ZinTrust/ZinTrust/actions/workflows/security.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/security.yml?query=branch%3Adev)
...
| Check        | Status                                                                                                                                                                                                                                                                                                                                           |
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| **Build**    | [![CI/CD Pipeline](https://github.com/ZinTrust/ZinTrust/actions/workflows/ci.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/ci.yml?query=branch%3Adev)                                                                                                                                                        |
| **Quality**  | [![SonarQube Analysis](https://github.com/ZinTrust/ZinTrust/actions/workflows/sonarqube.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/sonarqube.yml?query=branch%3Adev)                                                                                                                                      |
| **Security** | [![Security Scan](https://github.com/ZinTrust/ZinTrust/actions/workflows/security.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/security.yml?query=branch%3Adev) [![Known Vulnerabilities](https://snyk.io/test/github/ZinTrust/ZinTrust/badge.svg)](https://snyk.io/test/github/ZinTrust/ZinTrust)          |
| **Docker**   | [![Publish Docker Image](https://github.com/ZinTrust/ZinTrust/actions/workflows/docker-publish.yml/badge.svg?branch=dev)](https://github.com/ZinTrust/ZinTrust/actions/workflows/docker-publish.yml?query=branch%3Adev) [![Docker Image](https://img.shields.io/badge/image-ghcr.io%2FZinTrust%2FZinTrust-blue)](https://github.com/ZinTrust/ZinTrust/pkgs/container/zintrust) |
