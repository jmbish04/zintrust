  ...
  test: {
    ...
    coverage: {
      ...
      exclude: [
        ...
        'src/cli/commands/QueueRecoveryCommand.ts',
        'src/cli/commands/WorkerCommands.ts',
        'src/cli/commands/RoutesCommand.ts',
        'src/cli/commands/ContainerProxiesCommand.ts',
        'src/cli/commands/DeployCommand.ts',
        'src/cli/commands/MongoDBProxyCommand.ts',
        'src/cli/commands/ContainerWorkersCommand.ts',
        'src/cli/commands/InitProxyCommand.ts',
        'src/cli/commands/SqlServerProxyCommand.ts',
        'src/cli/commands/DoctorArchitectureCommand.ts',
        'src/cli/commands/DeployContainerProxiesCommand.ts',
        'src/**/types.ts',
        'src/scripts/**',
        'src/features/**',
        'src/node-singletons/**',
