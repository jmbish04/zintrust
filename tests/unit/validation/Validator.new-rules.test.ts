...
describe('Validator - New Validation Rules', () => {
  describe('alphanumeric', () => {
    ...
    it('works with rule string syntax', () => {
  ...
  describe('ipAddress', () => {
    ...
    it('works with rule string syntax using alias', () => {
  ...
  describe('phone', () => {
    ...
    it('rejects invalid phone numbers', () => {
      ...
      expect(() => Validator.validate({ mobile: '1' }, schema)).toThrow(); // Too short (needs at least 2 digits)
    });
  });
  ...
  describe('combined rules', () => {
    it('validates multiple new rules together', () => {
  ...
  describe('custom error messages', () => {
    it('supports custom messages for new rules', () => {
      const schema = Schema.create()
